        ...
        <div className="flex flex-row justify-center gap-x-4 md:gap-x-12 p-2 overflow-x-hidden py-20 pl-15 md:pl-40 xl:pl-50">
            ...
            <div className="flex flex-col justify-center items-center w-full gap-y-6 overflow-x-hidden md:pl-18 lg:pl-40">
                ...
                {posts.slice().reverse().map(post =>(
                    <div key={post.id} className="flex flex-row border border-gray-800 px-6 pt-5 pb-1 rounded-lg text-sm md:text-lg w-[300px] sm:w-[470px] lg:w-[650px] gap-x-2">
                        ...
                        <div className="flex flex-col gap-y-2" style={{ fontFamily: 'Roboot-Bold' }}>
                            ...
                            <div className="flex flex-row items-center hover:text-pink-400"> <button className="hover:bg-rose-500/50 h-8 w-8 rounded-full text-gray-700 hover:text-pink-400" onClick={() => handleLike(post.id)}><FontAwesomeIcon icon={faHeart} /></button>
